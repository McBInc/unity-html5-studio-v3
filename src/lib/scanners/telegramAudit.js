...
export async function auditTelegramCompliance(tmpRoot, buildDir, projectRoot) {
    let score = 100;
    ...
    try {
        ...
        if (indexHtml.includes("telegram.org/js/telegram-web-app.js")) {
            ...
            criticalFailures.push({
                id: "TG_SDK_MISSING",
                description: "Telegram Web App SDK (telegram-web-app.js) is missing. The game cannot communicate with the Telegram client without this.",
